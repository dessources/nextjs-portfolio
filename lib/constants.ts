export const SITE_CONFIG = {
  ...
  description:
    "Experienced frontend developer specializing in React, TypeScript, and modern web technologies. Building performant, scalable applications with clean code and exceptional user experiences.",
  url: "https://jaemdessources.com",
  ogImage: "/images/og-image.jpg",
  author: {
    name: "Jaemde Dessources",
    email: "jdess010@fiu.edu",
...
export const PROJECTS_DATA = [
  {
    ...
    description:
      "Real-time chat application built with React and modern web technologies. Features include live messaging, user authentication, and responsive design.",
  ...
  },
  {
    ...
    description:
      "E-commerce website showcasing coffee products with modern design and smooth user experience.",
  ...
  },
  {
    ...
    description:
      "A corporate website built using WordPress for a business that provides digital services to small businesses.",
